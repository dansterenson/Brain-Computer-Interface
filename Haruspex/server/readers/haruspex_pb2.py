...
_COMBINED = _descriptor.Descriptor(
  name='Combined',
  full_name='Combined',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='Combined.user', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='Combined.snapshot', index=1,
...
_COMBINED.fields_by_name['user'].message_type = _USER
_COMBINED.fields_by_name['snapshot'].message_type = _SNAPSHOT
...
DESCRIPTOR.message_types_by_name['Combined'] = _COMBINED
...
Combined = _reflection.GeneratedProtocolMessageType('Combined', (_message.Message,), dict(
  DESCRIPTOR = _COMBINED,
  __module__ = 'haruspex_pb2'
  # @@protoc_insertion_point(class_scope:Combined)
  ))
_sym_db.RegisterMessage(Combined)
